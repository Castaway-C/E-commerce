...
export function HomePage() {
  ...
  useEffect(() => {
    ...
    void productService.listProducts({ page: 1, page_size: 1 }).then((r) => setProductCount(r.data.total)).catch(() => {})
    void orderService.listOrders({ page: 1, page_size: 1 }).then((r) => setOrderCount(r.data.total)).catch(() => {})
    void communityService.listPosts({ page: 1, page_size: 1 }).then((r) => setPostCount(r.data.total)).catch(() => {})
    void productService.listProducts({ page: 1, page_size: 4 }).then((r) => setRecommended(r.data.list)).catch(() => {})
  }, [])
